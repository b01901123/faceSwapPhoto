...
public class PhotoViewerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //another face photo
        InputStream stream2 = getResources().openRawResource(R.raw.jolie);
        ...
        //create frame2 for bitmap2
        Frame frame2 = new Frame.Builder().setBitmap(bitmap2).build();
        SparseArray<Face> faces2 = safeDetector.detect(frame2);
        ...
        //show bitmap2 as well
        FaceView overlay2 = (FaceView) findViewById(R.id.faceView2);
        overlay2.setContent(bitmap2, faces2);

        ModifiedFaceView modifiedFaceView = (ModifiedFaceView)findViewById(R.id.modifiedView);
        modifiedFaceView.setContent(bitmap,faces,bitmap2,faces2);
